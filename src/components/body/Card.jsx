...
const Card = () => {
  return (
    <div className='flex flex-shrink-0 gap-4 bg-light-pink-100 w-full h-52 rounded-lg shadow-lg overflow-hidden relative md:h-64'>
      <div>
      ...
      <div className='absolute flex justify-center items-center bg-chocolate-100 rounded-full w-16 h-6 top-2 left-2 md:w-20 h-8'>
